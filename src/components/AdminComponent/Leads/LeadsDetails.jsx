        ...
        <div className=" flex gap-4">
          <div className="mt-2 w-fit bg-brand-white border border-brand-stroke p-3 rounded-xl">
            <p className=" font-medium text-sm text-brand-muted">
              ...
              <span className="font-park text-brand-primary font-semibold text-base ">
                {leadsDetailsData?.pagination.total}
              </span>
            </p>
          </div>
          ...
          <thead className="bg-brand-white rounded-2xl">
            <tr>
              {[
                ...
                <th
                  key={header}
                  className="p-3 font-medium text-sm text-brand-muted text-left rounded-l-lg"
                >
                  {header}
                </th>
              ))}
