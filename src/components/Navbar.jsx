...
const Navbar = ({isScrolled,openAddModal,
          ...
          <div className="flex gap-6">         
            <DropdownMenu.Root className={'border-none shadow-md text-left'}>
              ...
              >
                  ...
                  <DropdownMenu.Item onClick={handleLogout} className="px-3 py-2 text-sm flex text-brand-red font-medium  items-center gap-2 hover:bg-brand-red/10 cursor-pointer">
