            ...
            <table className="w-full border-collapse text-left">
                <thead className="bg-brand-offwhite rounded-2xl">
                    <tr>
                        ...
                        <th className="p-3 font-medium text-sm text-brand-muted">Leads Criteria</th>
                        ...
                        <th className="p-3 font-medium text-sm text-brand-muted">Last Updated</th>
                        ...
                        <tr key={order._id} className="border-b border-brand-stroke ">
                            ...
                            <td className="p-3 text-right relative">
                                <DropdownMenu.Root className={'border-none shadow-md text-left'}>
                                    ...
                                    >
                                        <DropdownMenu.Item onClick={() => openOrderDetails(order)} className="px-3 py-2 text-sm border-brand-white hover:bg-brand-sky cursor-pointer">
                                            View Details
                                        </DropdownMenu.Item>
                                        <DropdownMenu.Item onClick={() => openViewLeads(order)} className="px-3 py-2 text-sm border-brand-white hover:bg-brand-sky cursor-pointer">
                                            View Leads
                                        </DropdownMenu.Item>
                                    </DropdownMenu.Content>
                                </DropdownMenu.Root>
