      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="">
            ...
            {renderChange(dashboardData?.leadsDeliveredTodayChangePct)}
          </div>
        </div>
        ...
        >
          ...
          <div className="">
            ...
            <p className="text-brand-muted font-light mt-4">
              Since account activation
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="flex w-full justify-between items-center gap-4 mt-4 text-sm">
              ...
              <Link
                to={"/orders"}
                className="text-brand-blue font-medium flex items-center gap-3"
              >
                View Orders <MoveRight size={18} />
              </Link>
            </div>
          </div>
        </div>
        ...
        {/* CARD 4 */}
        <div
          className="bg-brand-darkblue border border-brand-offwhite 
        ...
        >
          <div>
            ...
            <p className="text-brand-stroke text-xs font-light mt-2">
              We are here to guide you through tracking, delivery, and any
              related questions.
            </p>
          </div>
